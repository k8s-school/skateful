...
def _build_yaml(data_path, pvc_name, hostname, instance, namespace, output_dir, template_dir):
    ...
    yaml_data['metadata']['name'] = "{}-{}".format(namespace, pvc_name)
    yaml_data['metadata']['labels']['pvc_name'] = pvc_name
    yaml_data['metadata']['labels']['instance'] = instance
    yaml_data['metadata']['labels']['namespace'] = namespace
...
if __name__ == "__main__":
    try:
        ...
        parser.add_argument('-p', '--pvcname', dest='pvc_name',
        ...
        parser.add_argument('-n', '--namespace', dest='namespace',
                            required=True, metavar='<namespace>',
                            help='Name of qserv namespace')

        args = parser.parse_args()

        _build_yaml(args.data_path, args.pvc_name, args.hostname, args.instance, args.namespace, args.output_dir, args.template_dir)
